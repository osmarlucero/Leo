        ...
        <div id="main">
            ...
            <div class="square">
                ...
                <div class="square_inner">
                    <form>
                    <ul id="list_form">
                        <li><input type="text" name="name" placeholder="Nombre Reportante"></li>
                        <li><input type="number" name="phone_number" placeholder="Numero De Telefono Reportante"></li>
                        <li>Fecha De Reporte<input type="date" name="phone_number" placeholder="Numero De Telefono Reportante"></li>
                        <li>
                            <select>
                                <option>Animal Que Reporta</option>
                                <option>Panfilo</option>
                            </select>
                        </li>
                        <li><textarea type="text" name="vaccine" placeholder="Incidente"></textarea></li>
                        <li>Imagen Del Incidente <input type="file" name="imageCover" required="" placeholder="Imagen Pelicula" accept="image/*"> </li>
                        <li>
